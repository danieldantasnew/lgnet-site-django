...
class Planos(models.Model):
    ...
    velocidade = models.CharField(("Velocidade"), max_length=100)
    destaque = models.BooleanField(default=False, help_text="marque esta opção se deseja destacar o plano")
    download = models.CharField(("Download"), max_length=100, help_text="Exemplo: 200MEGA")
    upload = models.CharField(("Upload"), max_length=100, help_text="Exemplo: 100MEGA")
